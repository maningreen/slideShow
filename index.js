...
// include: /tmp/nix-shell-2321-1717221675/tmp4jo7j2w6.js
...
Module['FS_createPath']("/", "resources", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/StackOfBooks.png", "start": 0, "end": 60376}, {"filename": "/resources/body.ttf", "start": 60376, "end": 2956724}, {"filename": "/resources/brain.png", "start": 2956724, "end": 3098005}, {"filename": "/resources/flame.jpg", "start": 3098005, "end": 3765398}, {"filename": "/resources/instagram.png", "start": 3765398, "end": 4288088}, {"filename": "/resources/slideshow.toml", "start": 4288088, "end": 4299942}, {"filename": "/resources/sloth.jpg", "start": 4299942, "end": 4648124}, {"filename": "/resources/sources.md", "start": 4648124, "end": 4648864}], "remote_package_size": 4648864});

  })();

// end include: /tmp/nix-shell-2321-1717221675/tmp4jo7j2w6.js
// include: /tmp/nix-shell-2321-1717221675/tmpv85q_tjo.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/nix-shell-2321-1717221675/tmpv85q_tjo.js
// include: /tmp/nix-shell-2321-1717221675/tmpq15opqlh.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/nix-shell-2321-1717221675/tmpq15opqlh.js
...
var ASM_CONSTS = {
  131116: () => { if (document.fullscreenElement) return 1; },  
 131162: () => { return document.getElementById('canvas').width; },  
 131214: () => { return parseInt(document.getElementById('canvas').style.width); },  
 131282: () => { document.exitFullscreen(); },  
 131309: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 131382: () => { if (document.fullscreenElement) return 1; },  
 131428: () => { return document.getElementById('canvas').width; },  
 131480: () => { return screen.width; },  
 131505: () => { document.exitFullscreen(); },  
 131532: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 131665: () => { return window.innerWidth; },  
 131691: () => { return window.innerHeight; },  
 131718: () => { if (document.fullscreenElement) return 1; },  
 131764: () => { return document.getElementById('canvas').width; },  
 131816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 131884: () => { if (document.fullscreenElement) return 1; },  
 131930: () => { return document.getElementById('canvas').width; },  
 131982: () => { return screen.width; },  
 132007: () => { return window.innerWidth; },  
 132033: () => { return window.innerHeight; },  
 132060: () => { if (document.fullscreenElement) return 1; },  
 132106: () => { return document.getElementById('canvas').width; },  
 132158: () => { return screen.width; },  
 132183: () => { document.exitFullscreen(); },  
 132210: () => { if (document.fullscreenElement) return 1; },  
 132256: () => { return document.getElementById('canvas').width; },  
 132308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 132376: () => { document.exitFullscreen(); },  
 132403: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 132461: () => { return screen.width; },  
 132486: () => { return screen.height; },  
 132512: () => { return window.screenX; },  
 132539: () => { return window.screenY; },  
 132566: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 132619: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 132690: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 132747: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 133003: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 133074: () => { if (document.fullscreenElement) return 1; },  
 133120: () => { return window.innerWidth; },  
 133146: () => { return window.innerHeight; },  
 133173: () => { if (document.pointerLockElement) return 1; }
};
